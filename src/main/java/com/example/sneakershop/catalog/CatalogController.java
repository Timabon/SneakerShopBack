...
public class CatalogController {
  ...
  public ResponseEntity<Catalog> addProductToCatalog(
  ...
  public ResponseEntity<Catalog> addProductsToCatalog(
      @PathVariable Long id, @RequestBody List<Product> products) {
  ...
  @DeleteMapping("{id}")
  public ResponseEntity<Void> removeProductsFromCatalog(
      @PathVariable Long id, @RequestBody List<Product> products) {
