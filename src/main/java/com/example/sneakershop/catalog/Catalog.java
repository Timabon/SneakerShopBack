...
public class Catalog {
  ...
  @ManyToMany // tells db it can have ManytoMany relation -> 1 catalog can have a lot of Products,
  // and 1 Product can be in a lot of Catalogs
