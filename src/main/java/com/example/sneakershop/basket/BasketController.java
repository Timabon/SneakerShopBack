...
public class BasketController {
  ...
  public ResponseEntity<String> addProduct(
      @PathVariable Long userId, @RequestBody Product product, @RequestParam int amount) {
  ...
  public ResponseEntity<String> removeProduct(
      @PathVariable Long userId, @RequestBody Product product) {
  ...
  public ResponseEntity<String> checkout(
      @RequestParam Long userId, @RequestParam String orderDescription) {
